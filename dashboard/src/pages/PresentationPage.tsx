...
const SLIDES: SlideData[] = [
  ...
  },
  {
    ...
    title: 'Architecture',
    bullets: [
      '• Environment layer: synthetic DGPs + real Elia data',
      '• Agent layer: honest, noisy, and adversarial policies',
      '• Platform layer: deterministic core mechanism',
      '',
      '• Agents produce (participate, report, deposit)',
      '• Core processes actions without knowing motives',
      '• Validated with 20+ invariant and property-based tests',
    ],
  ...
  },
  {
    ...
    bullets: [
      '• Elia wind: 17,544 rounds, 5 forecasters',
      '• Models: ARIMA, XGBoost, MLP, MA, Naive',
      '• Mechanism: −21% CRPS vs equal weights',
      '• Electricity: smaller improvement (forecasters more similar)',
      '',
