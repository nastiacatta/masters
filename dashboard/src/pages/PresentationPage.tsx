...
const SLIDES: SlideData[] = [
  ...
  /* 2 — What Is a Prediction Market? */
  {
    ...
    bullets: [
      '▸ Market for uncertain future outcomes',
      '▸ Participants submit forecasts and wagers',
      '▸ The market aggregates forecasts into a single market forecast',
      '▸ Rewards are allocated after the outcome is observed',
      '',
      '→ Useful when predictive information is distributed but raw data is costly to share',
    ],
