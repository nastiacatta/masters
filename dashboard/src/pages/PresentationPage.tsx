...
const SLIDES: SlideData[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      '',
      '• Warning: wash trading ~60% of Polymarket volume [1]',
      '• Warning: prices shaped by small elite, not broad crowd [2]',
      '',
  ...
  },
  {
    ...
    bullets: [
      '• When present: loss state updates via EWMA blending',
      '• When absent: staleness decay reverts skill toward prior',
  ...
  },
  {
    ...
    bullets: [
      ...
      '• Best forecaster (noise σ = 0.15): learned skill = 0.959',
      '• Worst forecaster (noise σ = 1.00): learned skill = 0.820',
