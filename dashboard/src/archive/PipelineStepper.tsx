  ...
  return (
    <div className="p-6 max-w-4xl space-y-8">
      ...
      <PageHeader
        ...
        subtitle="Step-by-step flow: Inputs → DGP / private signal → Behaviour policy → Core mechanism → Results. Choose components at each step to explore the project mechanism."
