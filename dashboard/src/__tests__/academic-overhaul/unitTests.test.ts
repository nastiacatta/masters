...
describe('15.18 HomePage cleanup — pure logic', () => {
  ...
  const FINDINGS = [
    { color: '#10b981', title: 'Modest CRPS reduction on Elia wind; essentially flat on electricity', detail: 'Across 17,544 hourly points on Elia offshore wind with seven forecasting models (Naive, EWMA, ARIMA, XGBoost, MLP, Theta, Ensemble), the skill x stake aggregate cuts mean CRPS by 7.6% relative to equal weighting under strictly-causal normalisation. On Elia electricity prices the mechanism improvement is under 1%.' },
