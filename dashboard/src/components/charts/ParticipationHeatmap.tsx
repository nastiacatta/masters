...
import { sequentialBlue, rgbToCSS } from '@/lib/colourScales';
          ...
          <div className="shrink-0 pr-2">
            {agents.map(a => (
              <div key={a} className="flex items-center justify-end" style={{ height: cellH }}>
                <span className="text-[11px] text-slate-500 font-medium">{agentDisplayName(a)}</span>
              </div>
            ))}
          </div>
          <div>
                  ...
                  .map((b, i) => (
                    <div
                      ...
                      style={{
                        width: cellW,
                        height: cellH - 2,
                        background: rgbToCSS(sequentialBlue(b.rate)),
                        borderRadius: 2,
                        margin: '1px 0.5px',
                      }}
            ...
            <div className="flex justify-between mt-1" style={{ width: nBlocks * (cellW + 1) }}>
              ...
              <span className="text-[11px] text-slate-400">{maxT}</span>
            </div>
          </div>
        </div>
            ...
            {[0, 0.25, 0.5, 0.75, 1].map(v => (
              <div
                ...
                style={{
                  width: 20,
                  height: 12,
                  background: rgbToCSS(sequentialBlue(v)),
                  borderRadius: 2,
