...
const LABELS: Record<LabelType, { short: string; full: string; color: string }> = {
  ...
  user_choice: { short: 'User choice', full: 'User choice', color: 'bg-amber-50 text-amber-800 border-amber-200' },
  mechanism_computation: { short: 'Mechanism', full: 'Mechanism computation', color: 'bg-blue-50 text-blue-800 border-blue-200' },
