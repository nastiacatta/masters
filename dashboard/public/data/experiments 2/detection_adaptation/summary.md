...
Compares a fixed manipulator with an adaptive evader that balances manipulation with detector evasion.

## Configuration

- DGP / setup: detection_adaptation
- Rounds: 1000
...
- **attacker_cumulative_profit**: -50.01
