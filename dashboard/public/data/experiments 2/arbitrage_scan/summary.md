...
Runs arbitrageurs across a parameter grid to see when arbitrage appears and whether it dominates wealth.

## Configuration

- DGP / setup: arbitrage_scan
- Rounds: 1000
...
- **attacker_cumulative_profit**: 17.84
