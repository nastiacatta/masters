...
from onlinev2.mechanism.models import AgentInput, MechanismParams, MechanismState
...
from onlinev2.mechanism.settlement import settle_round
from onlinev2.mechanism.aggregation import aggregate_forecast
from onlinev2.mechanism.skill import update_ewma_loss, loss_to_skill
...
def run_round(
    *,
    ...
    # Post-round skill: sigma for next round is derived from L_new (this round's loss update)
