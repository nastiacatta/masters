...
from online_algorithms.online_skill import (
    update_ewma_loss,
    loss_to_skill,
    calibrate_gamma,
    missingness_L0,
)
from online_algorithms.effective_wager import effective_wager

from online_algorithms.staking import (
...
def unit_roi_bounds(seed: int = 5, n: int = 10, eps: float = 1e-12, tol: float = 1e-10) -> bool:
    ...
    from payoff.payoff import skill_payoff as _skill_payoff
...
def unit_wager_independent_of_current_loss(seed: int = 100) -> bool:
    ...
    from online_algorithms.effective_wager import effective_wager as eff_wager
    rng = np.random.default_rng(seed)
    n = 4
