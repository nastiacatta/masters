...
All models are strictly causal — they use only data up to time t minus one to predict time t. Quantiles are generated via residual bootstrap with isotonic monotonicity enforcement.
