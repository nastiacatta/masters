...
5. **Restart-per-season decomposition.** The full-run −7.1% is partly cross-seasonal adaptation; within a single season the mechanism is −0.83% to −1.20% every season without exception. This is not a contradiction; it is a decomposition. Open question: how to present it so neither reading is overstated.
