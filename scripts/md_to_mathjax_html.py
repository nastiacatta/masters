...
<html lang="en">
  <head>
    ...
    <script defer src="https://cdn.jsdelivr.net/npm/marked-gfm-heading-id@3.1.0/lib/index.umd.js"></script>
    <script defer src="https://cdn.jsdelivr.net/npm/marked-highlight@2.1.4/lib/index.umd.js"></script>
  ...
  <body>
    ...
    <script>
      ...
      async function render() {{
        // Configure marked with GFM + heading ids + highlighting.
        ...
        // After Markdown is in the DOM, typeset math.
      ...
      window.addEventListener('DOMContentLoaded', () => {{
        // marked + helpers are defer-loaded, so wait a tick.
        setTimeout(() => render(), 0);
      }});
    </script>
  </body>
