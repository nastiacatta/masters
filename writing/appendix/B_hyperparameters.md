# Hyperparameter tuning {#app:hyperparameters}
...
The sweep grid, held-out evaluation protocol, and best-CRPS optima
are given below.
...
The grid is intentionally coarse. Local refinement produced
marginal improvements (CRPS changes of order $10^{-4}$).
...
$f_{\mathrm{stake}} = 0.05$. These are not swept in this thesis;
sensitivity to $\beta_c$ is reported in §5.1 (deposit-policy
ablation).
